"""3D molecular visualization using NGLView.

This module provides functions for visualizing molecular structures and docking
results in Jupyter Notebook environments using NGLView. It supports interactive
3D rendering of proteins, ligands, and docking poses.

The visualization functions handle:
    - Single molecule rendering (proteins or ligands)
    - Multi-pose docking result visualization with interactive controls
    - Automatic pose navigation and animation
    - Customizable representation styles
...
Note:
    These functions require a Jupyter Notebook/Lab environment and the
    nglview package. They will not work in standard Python scripts.
"""
