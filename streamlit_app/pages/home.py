...
FEATURES = [
    ...
    ("🌐", "Molecule Fetcher",
     "Fetch protein (PDB) and ligand (SDF) structures directly from RCSB PDB, PubChem, and ChEMBL."),
    ("🔍", "Interaction Profiling",
     "Analyse protein–ligand interactions post-docking with ProLIF fingerprinting."),
    ("🧩", "Format Converter",
     "Easily convert between multiple molecular file formats locally using Open Babel."),
    ("🧪", "MolSynthAI",
     "Generate structurally similar molecules for docking & lead optimization — powered by AI."),
]
...
TECH = [
    ...
    "NGLView", "ProLIF", "RCSB PDB", "PubChem",
    "ChEMBL",
]
